...
# 設定資料集路徑
dataset_path = r"C:\Users\user\Desktop\cnn\CNN_complete_rm50"  # 替換為你的圖片資料集路徑
...
model = tf.keras.models.Sequential([
    # 使用卷積層來處理圖像數據
    tf.keras.layers.Conv2D(64, (3, 3), activation='relu', input_shape=(img_height, img_width, 1)),  # 使用具體的輸入形狀
    ...
    tf.keras.layers.Dense(num_classes, activation='softmax')  # 改成 softmax 作為輸出激活函數
])
...
# 儲存模型
model.save('cnn_complete_rm50.h5')
