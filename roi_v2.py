...
if __name__ == '__main__':
    ...
    # 區塊一
    points1 = np.array([[132, 65], [270, 1430], [595, 600], [1134, 200]], dtype=np.int32)
    points2 = np.array([[0, 2500], [0, 6000], [2160, 6000], [1434, 2727]], dtype=np.int32)
    points3 = np.array([[2955, 6000], [7145, 4525], [6243, 2520], [2268, 3031]], dtype=np.int32)
    ...
    cv2.imshow('roi_1', cv2.resize(roi_1, None, fx=0.5, fy=0.5))
    cv2.waitKey(0)
